...
export const FullScreenScrollFX = forwardRef(
  (
    ...
    const cssVars = {
      "--fx-font": fontFamily,
      "--fx-text": colors.text ?? "rgba(26,26,26,0.92)",
      "--fx-overlay": colors.overlay ?? "rgba(255,255,255,0.45)",
      "--fx-page-bg": colors.pageBg ?? "#FAFAF7",
      "--fx-stage-bg": colors.stageBg ?? "#F0EDE8",
      "--fx-gap": `${gap}rem`,
      "--fx-grid-px": `${gridPaddingX}rem`,
      "--fx-row-gap": "10px",
    };

    const sectionHeight = `${Math.max(1, total + 1)}00vh`;
            ...
            <div className="fx-fixed" ref={fixedRef}>
              ...
              <div className="fx-grid">
                ...
                <div className="fx-footer">
                  {footer && (
                    <div className="fx-footer-title">{footer}</div>
                  )}
                  {showProgress && (
